...
class _SmoothCarouselProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) {
    final visibleTabs = [
      ..._originalTabs,
      ..._originalTabs,
      ..._originalTabs, // Append extra sets for seamless wrap-around
    ];
                  ...
                  child: PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      final logicalIndex = index %
                          _originalTabs.length; // Logical index for wrap-around
...
Widget _buildEditUI(Function() onTap) {
    ...
    child: Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          kheight20,
          _buildEditableField("Name", "Nidhin V Ninan"),
          kheight20,
          _buildEditableField("Email", "nidhinvninan29@gmail.com"),
          kheight20,
          Row(
            children: [
              Expanded(child: _buildEditableField("Weight", "50 kg")),
              SizedBox(width: 10.w),
              Expanded(child: _buildEditableField("Height", "180 cm")),
            ],
          ),
          kheight20,
          Row(
            children: [
              Expanded(child: _buildEditableField("Age", "21")),
              SizedBox(width: 10.w),
              Expanded(child: _buildEditableField("Blood Group", "0+ve")),
            ],
          ),
          kheight20,
          _buildEditableField("Insurance", "Yes"),
          SizedBox(height: 100.h),
        ],
      ),
    ),
